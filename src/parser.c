...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [aux_sym_keyword_selector_repeat1] = STATE(26),
  ...
  [2] = {
    ...
    [sym_unary_message] = STATE(55),
    [sym_binary_message] = STATE(55),
    [sym_keyword_message] = STATE(55),
    [sym_assignment] = STATE(55),
    [sym_string] = STATE(50),
    [sym_symbol] = STATE(50),
    [sym_statement] = STATE(70),
    [sym_return] = STATE(80),
    [sym_dynamic_array] = STATE(50),
    [sym_byte_array] = STATE(50),
    [sym_parenthesized_expression] = STATE(50),
    [sym_block] = STATE(50),
    [sym_primary] = STATE(55),
  ...
  [3] = {
    ...
    [sym_primary] = STATE(55),
    [sym_expression] = STATE(62),
    [aux_sym_temporaries_repeat1] = STATE(74),
  ...
  [4] = {
    ...
    [sym_primary] = STATE(55),
    [sym_expression] = STATE(62),
    [aux_sym_method_repeat1] = STATE(78),
  ...
  [6] = {
    ...
    [sym_primary] = STATE(55),
    [sym_expression] = STATE(62),
    [aux_sym_method_repeat1] = STATE(91),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(103)] = 1436,
  [SMALL_STATE(104)] = 1440,
  [SMALL_STATE(105)] = 1444,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [77] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_keyword_selector, 1),
  [79] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_keyword_selector, 1),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_keyword_selector_repeat1, 2),
  [83] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_keyword_selector_repeat1, 2), SHIFT_REPEAT(96),
  [86] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_keyword_selector_repeat1, 2),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_temporaries, 2, .dynamic_precedence = 10),
  [90] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [92] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_temporaries, 2, .dynamic_precedence = 10),
  [94] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_temporaries, 2, .dynamic_precedence = 10), SHIFT(74),
  ...
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selector, 1),
  [111] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_selector, 1),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_keyword_message_repeat1, 2),
  [115] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_keyword_message_repeat1, 2), SHIFT_REPEAT(21),
  [118] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_keyword_message_repeat1, 2),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_message, 3),
  [122] = {.entry = {.count = 1, .reusable = false}}, SHIFT(53),
  [124] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_keyword_message_repeat1, 2), SHIFT(21),
  ...
  [135] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_keyword_message, 2, .dynamic_precedence = -1), SHIFT(21),
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_keyword_message, 2, .dynamic_precedence = -1),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_primary, 1),
  [142] = {.entry = {.count = 1, .reusable = true}}, SHIFT(23),
  [144] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_primary, 1),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_symbol, 4),
  [148] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_symbol, 4),
  ...
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_byte_array, 2),
  [160] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_byte_array, 2),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 8),
  [164] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 8),
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dynamic_array, 2),
  [168] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dynamic_array, 2),
  ...
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 6),
  [180] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 6),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 5),
  [184] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 5),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dynamic_array, 5),
  [188] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dynamic_array, 5),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_message, 2),
  [192] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_message, 2),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 3),
  [196] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 3),
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression, 1),
  [200] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression, 1),
  [202] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_byte_array, 3),
  [204] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_byte_array, 3),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dynamic_array, 4),
  [208] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dynamic_array, 4),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 3),
  [212] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 3),
  [214] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_symbol, 2),
  [216] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_symbol, 2),
  [218] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dynamic_array, 3),
  [220] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dynamic_array, 3),
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_return, 2),
  [224] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 1),
  [226] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_temporaries_repeat1, 1),
  [228] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_primary, 1), REDUCE(aux_sym_temporaries_repeat1, 1),
  [231] = {.entry = {.count = 1, .reusable = true}}, SHIFT(19),
  [233] = {.entry = {.count = 1, .reusable = true}}, SHIFT(60),
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_dynamic_array_repeat1, 2),
  [237] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [239] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [241] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [243] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_byte_array_repeat1, 2), SHIFT_REPEAT(69),
  [246] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_byte_array_repeat1, 2),
  ...
  [264] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(76),
  [267] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method, 4),
  [269] = {.entry = {.count = 1, .reusable = true}}, SHIFT(69),
  [271] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [273] = {.entry = {.count = 1, .reusable = true}}, SHIFT(74),
  [275] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_temporaries_repeat1, 2),
  [277] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_temporaries_repeat1, 2), SHIFT_REPEAT(83),
  [280] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dynamic_array_repeat1, 2), SHIFT_REPEAT(24),
  [283] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_method_repeat1, 2),
  [285] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_method_repeat1, 2), SHIFT_REPEAT(9),
  [288] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method, 3),
  [290] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [292] = {.entry = {.count = 1, .reusable = true}}, SHIFT(79),
  [294] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [296] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat2, 2), SHIFT_REPEAT(16),
  [299] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_repeat2, 2),
