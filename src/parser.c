...
enum {
  ...
  sym_cascaded_unary = 42,
  sym_cascaded_binary = 43,
  sym_cascaded_keyword = 44,
  sym_string = 45,
  sym_symbol = 46,
  sym_statement = 47,
  sym_return = 48,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [129] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_cascaded_binary, 2),
  ...
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_cascaded_keyword, 1),
  [144] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_cascaded_keyword, 1),
  ...
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_cascaded_unary, 1),
  [183] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_cascaded_unary, 1),
